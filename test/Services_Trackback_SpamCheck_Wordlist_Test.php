...
class Webservices_Trackback_SpamCheck_Wordlist_TestCase extends PHPUnit_TestCase
{
    ...
    function Webservices_Trackback_SpamCheck_Wordlist_TestCase($name) {
...
$suite  = new PHPUnit_TestSuite("Webservices_Trackback_SpamCheck_Wordlist_TestCase");
